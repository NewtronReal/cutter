...
class RzILTextEdit;
class RzILScrollArea;
class DisassemblyContextMenu;
class RzILLeftPanel;
class AddressRangeScrollBar;

class RzILWidget : public MemoryDockWidget
{
    Q_OBJECT
public:
    explicit RzILWidget(MainWindow *main);
...
protected:
    ...
    RzILScrollArea *mDisasScrollArea;
    RzILTextEdit *mDisasTextEdit;
    RzILLeftPanel *leftPanel;
...
class RzILScrollArea : public QAbstractScrollArea
{
    Q_OBJECT

public:
    explicit RzILScrollArea(QWidget *parent = nullptr);
...
class RzILTextEdit : public QPlainTextEdit
{
    Q_OBJECT
 ...
 */
class RzILLeftPanel : public QFrame
{
public:
    RzILLeftPanel(RzILWidget *disas);
